...
* Random effects with extra controls:
xtreg lnincome_consumption time09 time11 lndistance3_2 distime093_2 distime113_2 /// 
	lntnincomef  /// 
	age age2 sex educ hhsize hhsize2 labor acreage_land partymember,re vce(cluster cm)
...
* Table 3: Units of consumer durables: Poisson models
*--------------------------------------------------------------------
use "`rawdat'\Units of Consumer Durables Owned_FE.dta",clear
set more off
tset id year,yearly

xtpoisson condurable time09 time11 lndistance3_2 distime093_2 distime113_2 /// 
	lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_d3_poi
xtpoisson condurable time09 time11 lndistance5 distime095 distime115 /// 
	lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_d5_poi                
...
xtpoisson cd_enter time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  age age2 sex ///
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_ent_d3_poi
xtpoisson cd_enter time09 time11 lndistance5 distime095 distime115 lntnincomef  age age2 sex ///
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_ent_d5_poi                

xtpoisson cd_trans time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  age age2 sex ///
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_tran_d3_poi
xtpoisson cd_trans time09 time11 lndistance5 distime095 distime115 lntnincomef  age age2 sex /// 
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_tran_d5_poi                

xtpoisson cd_comf time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  age age2 sex ///
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_comf_d3_poi
xtpoisson cd_comf time09 time11 lndistance5 distime095 distime115 lntnincomef  age age2 sex /// 
	educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_comf_d5_poi

outreg2 [cd_d3_poi cd_d5_poi cd_ent_d3_poi cd_ent_d5_poi cd_tran_d3_poi cd_tran_d5_poi cd_comf_d3_poi cd_comf_d5_poi] ///
	using "`output'\Tab3_cons_dur", adds(chi-square test, e(chi2) ) replace  excel dec(3) ///
	sortvar(distime093_2 distime113_2 distime095  distime115 lntnincomef cpi giftexchangef loanf lndistance3_2 )  ///
	drop(age* sex hh* educ labor party acreag o.lndistance3_2) nocons
...
* Table 4: Cigarrettes and Alcohol
*-------------------------------------------
...
* Non-logged distance: 
rename distime093_2 lndistime093_2
rename distime113_2 lndistime113_2
rename distime095 lndistime095
rename distime115 lndistime115
* TRY THIS WITH non-LOGGED DISTANCE: 
gen distime093_2 = distance3_2*time09 
gen distime113_2 = distance3_2*time11
gen distime095   = distance5*time09
gen distime115   = distance5*time11


xtreg lnalcohol time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store alcohol_dis3_2
xtreg lnalcohol time09 time11 lndistance5 distime095 distime115 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store alcohol_dis5

xtreg lncigarette time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store cigarette_dis3_2
xtreg lncigarette time09 time11 lndistance5 distime095 distime115 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store cigarette_dis5

outreg2 [alcohol_dis3_2 alcohol_dis5 cigarette_dis3_2 cigarette_dis5] /// 
	using "`output'\alc_cig_fe", adds(Adjusted R-square, e(r2_a)) replace  excel dec(3) ///
	sortvar(distime093_2 distime113_2 distime095  distime115 lntnincomef cpi giftexchangef loanf lndistance3_2 )  ///
	drop(age* sex hh* educ labor party acreag o.lndistance3_2) nocons

* Then doing the same with a tobit!! - no fixed-effects for xttobit. Maybe I can do jackknife or a vce(boot)
xttobit lnalcohol time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember, ll(0) 
est store alc_tob_d3
xttobit lnalcohol time09 time11 lndistance5 distime095 distime115 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store alc_tob_d5

xttobit lncigarette time09 time11 lndistance3_2 distime093_2 distime113_2 lntnincomef  ///
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store cig_tob_d3
xttobit lncigarette time09 time11 lndistance5 distime095 distime115 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store cig_tob_d5

outreg2 [alc_tob_d3 alc_tob_d5 cig_tob_d3 cig_tob_d5] /// 
	using "`output'\alc_cig_tob_fe",  replace  excel dec(3) ///
	sortvar(distime093_2 distime113_2 distime095  distime115 lntnincomef cpi giftexchangef loanf lndistance3_2)  ///
 	drop(age* sex hh* educ labor party acreag o.lndistance3_2) nocons 



xtreg lnalcohol time09 time11 lndistance3_2 lndistime093_2 lndistime113_2 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store alcohol_dis3_2
xtreg lnalcohol time09 time11 lndistance5 lndistime095 lndistime115 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store alcohol_dis5

xtreg lncigarette time09 time11 lndistance3_2 lndistime093_2 lndistime113_2 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store cigarette_dis3_2
xtreg lncigarette time09 time11 lndistance5 lndistime095 lndistime115 lntnincomef  age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(cluster cm)
est store cigarette_dis5

outreg2 [alcohol_dis3_2 alcohol_dis5 cigarette_dis3_2 cigarette_dis5] /// 
	using "`output'\lnalc_cig_fe", adds(Adjusted R-square, e(r2_a)) replace  excel dec(3) ///
	sortvar(lndistime093_2 lndistime113_2 lndistime095  lndistime115 lntnincomef cpi giftexchangef loanf lndistance3_2 )  ///
	drop(age* sex hh* educ labor party acreag o.lndistance3_2) nocons
	
* Then doing the same with a tobit!! - no fixed-effects for xttobit. Maybe I can do jackknife or a vce(boot)
xttobit lnalcohol time09 time11 lndistance3_2 lndistime093_2 lndistime113_2 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember, ll(0) 
est store alc_tob_d3
xttobit lnalcohol time09 time11 lndistance5 lndistime095 lndistime115 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store alc_tob_d5

xttobit lncigarette time09 time11 lndistance3_2 lndistime093_2 lndistime113_2 lntnincomef  ///
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store cig_tob_d3
xttobit lncigarette time09 time11 lndistance5 lndistime095 lndistime115 lntnincomef  /// 
		age age2 sex educ hhsize hhsize2 labor acreage_land partymember,  ll(0) 
est store cig_tob_d5

outreg2 [alc_tob_d3 alc_tob_d5 cig_tob_d3 cig_tob_d5] /// 
	using "`output'\lnalc_cig_tob_fe",  replace  excel dec(3) ///
	sortvar(lndistime093_2 lndistime113_2 lndistime095  lndistime115 lntnincomef cpi giftexchangef loanf lndistance3_2)  ///
 	drop(age* sex hh* educ labor party acreag o.lndistance3_2) nocons 	
	
crash
	
* Table XXXX: playing majiang
...
outreg2 [frequency_dis3_2 frequency_dis5 losingamount_dis3_2 losingamount_dis5] using "`output'\majiang_fe", adds(Adjusted R-square, e(r2_a)) replace  excel dec(3) 
