...
xtpoisson condurable time09 time11 lndistance3_2 distime093_2 distime113_2 /// 
	lntnincomef lntnincomef2 age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_d3_poi
xtpoisson condurable time09 time11 lndistance5 distime095 distime115 // 
	lntnincomef lntnincomef2 age age2 sex educ hhsize hhsize2 labor acreage_land partymember,fe vce(robust)
est store cd_d5_poi                
* don't replace so that it appends:              
* outreg2 [ condurable_32_poisson condurable_5_poisson] using "`output'\consumer durable_aggregate", ///
* 	adds( chi-square test, e(chi2) )  excel dec(3) 
